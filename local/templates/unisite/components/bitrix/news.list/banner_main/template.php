                            ...
                            <div class="col-lg-8">
                                <div class="banner">
                                    ...
                                    <?if($arItem["PROPERTIES"]["text1"]["VALUE"] || $arItem["PROPERTIES"]["text2"]["VALUE"]):?>
                                        <div class="buttons">
                                            <a href="<?=$arItem["PROPERTIES"]["url1"]["VALUE"];?>" class="btn-1"><?=$arItem["PROPERTIES"]["text1"]["VALUE"];?></a>
                                            <a href="<?=$arItem["PROPERTIES"]["url2"]["VALUE"];?>" class="btn-1 btn-2"><?=$arItem["PROPERTIES"]["text2"]["VALUE"];?></a>
                                        </div>
                                    <?endif;?>
                                </div>
